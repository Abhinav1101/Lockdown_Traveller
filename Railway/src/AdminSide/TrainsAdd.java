                    ...
                    try (ResultSet result = statement.executeQuery(query)) {
                        ...
                        if (flag != 0) {
                            try (Statement statement1 = con.createStatement()) {
                                String query1 = "INSERT into train(TrainType, train_no, name, src, dest, ArrTime, DepTime, SLFare, AC3Fare, AC2Fare, AC1Fare, date,SLSeat, AC1Seat, AC2Seat, AC3Seat )VALUES('" + cmbTrainType + "','" + txtTrainNo.getText() + "','" + txtTrainName.getText() + "','" + txtFrom.getText() + "','" + txtTo.getText() + "','" + time + "','" + time1 + "','" + txtSleeperFare.getText() + "','" + txtAC3Fare.getText() + "','" + txtAC2Fare.getText() + "','" + txtAC1Fare.getText() + "','" + sqlDate + "','" + SleeperSeats.getText() + "','" +AC1Seats.getText()+ "','" +AC2Seats.getText()+ "','" +AC3Seats.getText()+ "');";
                                statement1.executeUpdate(query1);
                                JOptionPane.showMessageDialog(this, "The Train has been added sucessfully!!");
